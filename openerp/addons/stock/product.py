...
class product_product(osv.osv):
    ...
    def _product_available(self, cr, uid, ids, field_names=None, arg=False, context=None):
        print "product available de product.product"
        context = context or {}
        field_names = field_names or []

        domain_products = [('product_id', 'in', ids)]
        domain_quant, domain_move_in, domain_move_out = self._get_domain_locations(cr, uid, ids, context=context)
        print "ddddd",domain_quant#, domain_move_in, domain_move_out = self._get_domain_locations(cr, uid, ids, context=context)
...
class product_template(osv.osv):
    ...
    def _product_available(self, cr, uid, ids, name, arg, context=None):
        ...
        print "product available de product.template"
        for product in self.browse(cr, uid, ids, context=context):
            res[product.id] = {
