...
class sale_order(osv.osv):
    ...
    def _get_date_planned(self, cr, uid, order, line, start_date, context=None):
        print "s",start_date#, DEFAULT_SERVER_DATETIME_FORMAT) + timedelta(days=line.delay or 0.0)
        print "ts",type(start_date)#, DEFAULT_SERVER_DATETIME_FORMAT) + timedelta(days=line.delay or 0.0)
        start_date= start_date +" 00:00:00"#, DEFAULT_SERVER_DATETIME_FORMAT) + timedelta(days=line.delay or 0.0)
        print "s",start_date#, DEFAULT_SERVER_DATETIME_FORMAT) + timedelta(days=line.delay or 0.0)
